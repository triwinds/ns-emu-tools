...
规则位于 ../streamline-fg-preflight/route-baseline.json；工具不会加载 DLL、运行 SDK setup 或修改 SDK。
...
~~~powershell
cargo build --locked --manifest-path src-tauri/crates/streamline-fg-preflight/Cargo.toml --bin sdk-route-audit
& src-tauri/crates/streamline-fg-preflight/target/debug/sdk-route-audit.exe --sdk-dir D:\py\ns-emu-tools\src-tauri\target\streamline-sdk-v2.12.0
~~~
