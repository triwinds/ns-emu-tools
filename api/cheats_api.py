...
def scan_all_cheats_folder():
    from module.cheats.cheats import scan_all_cheats_folder
...
def list_all_cheat_files_from_folder(folder_path: str):
    from module.cheats.cheats import list_all_cheat_files_from_folder
    try:
...
def load_cheat_chunk_info(cheat_file_path: str):
    from module.cheats.cheats import load_cheat_chunk_info
    try:
...
def update_current_cheats(enable_titles: List[str], cheat_file_path: str):
    from module.cheats.cheats import update_current_cheats
    try:
...
def open_cheat_mod_folder(folder_path: str):
    from module.cheats.cheats import open_cheat_mod_folder
    try:
...
@eel.expose
def get_game_data():
    from module.cheats.cheats import get_game_data
    try:
